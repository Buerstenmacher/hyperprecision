...
*/
cout << "e       is:\t" << e<floatxx_t<64>>() << endl;

cout << "ln(1500.0)is:\t" << log(floatxx_t<32>{1500.0}) << endl;
cout << "3^3.1     is:\t" << pow(floatxx_t<32>{3.0},floatxx_t<32>{3.1}) << endl;
cout << "sin(20.0)  is:\t" << sin(floatxx_t<32>{20.0}) << endl;
cout << "cos(20.0)  is:\t" << cos(floatxx_t<32>{20.0}) << endl;
cout << "cos(2.0)*cos(2.0) + sin(2.0)*sin(2.0)  is:\t" << endl;
cout <<
cos(floatxx_t<16>{2.0})*
cos(floatxx_t<16>{2.0})+
sin(floatxx_t<16>{2.0})*
sin(floatxx_t<16>{2.0}) << std::endl <<
cos(floatxx_t<32>{2.0})*
cos(floatxx_t<32>{2.0})+
sin(floatxx_t<32>{2.0})*
sin(floatxx_t<32>{2.0}) << std::endl <<
cos(floatxx_t<64>{2.0})*
cos(floatxx_t<64>{2.0})+
sin(floatxx_t<64>{2.0})*
sin(floatxx_t<64>{2.0}) << std::endl <<
cos(floatxx_t<128>{2.0})*
cos(floatxx_t<128>{2.0})+
sin(floatxx_t<128>{2.0})*
sin(floatxx_t<128>{2.0}) << std::endl;

cout << "arcsin(-0.5)  is:\t" << arcsin(floatxx_t<64>{-0.50}) << endl;
cout << "arccos(-0.0)  is:\t" << arccos(floatxx_t<64>{-0.00}) << endl;
cout << "pi            is:\t" << pi<floatxx_t<64>>() << endl;
