...
cout << "it is: " << l << " lns<> "<<endl;
cout << "it is: " << pow(double{2},double{3127}) << " double" << endl;
...
cout << "ln(ln(ln(e^(e^(e^(7.0)))))) is:\t" <<
log(log(log(
exp(exp(exp(floatxx_t<64>{7.0})))))) <<"\t Try this calculation on any other calculator!!!" << endl;
